...
echo "🚀 Performing final project reset for Raft implementation..."

# --- Step 1: Forcefully delete all old and conflicting Go files ---
echo "Cleaning up old project files..."
rm -f state.go contracts.go mempool.go serf_manager.go main_simple_consensus.go fsm.go consensus.go main.go
